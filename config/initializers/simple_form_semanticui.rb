...
SimpleForm.setup do |config|
  ...
  config.wrappers :semantic_icon, tag: 'div', class: 'field', error_class: 'error', hint_class: 'with_hint' do |b|
    b.use :html5
    b.wrapper tag: 'div', class: 'ui left icon input' do |input|
      ...
      input.use :error, wrap_with: {tag: 'div', class: 'ui red pointing left label error'}
    end
  end
